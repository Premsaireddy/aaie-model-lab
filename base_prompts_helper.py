"""
Helper module to import and use base_prompts.py functions
"""
...
# Add the base prompts directory to Python path
base_prompts_dir = os.path.join(os.getcwd(), 'Model and Prompt Selection', 'Models', 'Base Prompts')
sys.path.insert(0, base_prompts_dir)
